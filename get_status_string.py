...
def get_random_status_string(health_percentage, type=None, status_dict=None):
    ...
    if health_percentage >= 80:
        number = random.randint(
            sum(
                1
                for tuple in status_dict
                if tuple[0] == 0 or tuple[0] == 20 or tuple[0] == 40 or tuple[0] == 60
            ),
            sum(
                1
                for tuple in status_dict
        ...
        number = random.randint(
            sum(
                1
                for tuple in status_dict
                if tuple[0] == 0 or tuple[0] == 20 or tuple[0] == 40
            ),
            sum(
                1
                for tuple in status_dict
        ...
        number = random.randint(
            sum(1 for tuple in status_dict if tuple[0] == 20 or tuple[0] == 0),
            sum(
                1
                for tuple in status_dict
                if tuple[0] == 0 or tuple[0] == 20 or tuple[0] == 40
        ...
        number = random.randint(
            sum(1 for tuple in status_dict if tuple[0] == 0),
