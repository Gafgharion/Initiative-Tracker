...
def write_current_health(participant, health_entry, current_health, status_label, initial_values):
...
def delayed_check_health_status(app, participant, health_entry, current_health, status_label, initial_values):
    ...
    app.main_frame.delayed_health_callback_id = app.after(
        200, lambda: write_current_health(participant, health_entry, current_health, status_label, initial_values)
    )
